...
<html lang="en">
    <head>
        <title>Hôtels et véhicules</title>
        <meta charset="utf-8">
          ...
          <div class="sidenav-content">
            ...
            <div class="flexslider slider" id="slider-3">
                <ul class="slides">
                    ...
                    <li class="item-1 back-size" style="background:			linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url(../../assets/img/5.jpg) 50% 65%;	background-size:cover;	height:100%;">
                    </li><!-- end item-1 -->
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 no-pd-r">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#hotels" data-toggle="tab"><span><i class="fa fa-building"></i></span><span class="st-text">Hôtels et véhicules</span></a></li>
