                        ...
                        <div class="col-sm-12">
                        	...
                        	<div class="flex-content">
                                <div class="custom-form custom-form-fields">
                                    <h3>Inscription</h3>
                                    <form action="../traitement/registration-ttt.php" method="post">
                                        ...
                                        <div class="form-group">
                                             <input type="number" name="phone" class="form-control" placeholder="Numéro de téléphone"  required/>
                                             <span><i class="fa fa-user"></i></span>
                                        </div>
                                    ...
                                    <div class="other-links">
                                    	<p class="link-line">Vous avez éjà un compte ? <a href="login.php">Connexion ici</a></p>
                                    </div><!-- end other-links -->
                                </div><!-- end custom-form -->

                                <div class="flex-content-img custom-form-img">
                                    <img src="../../assets/img/8.jpg" class="img-responsive" alt="registration-img" />
